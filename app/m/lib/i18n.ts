...
const EN = {
  ...
  al_save_prefs: "SAVE",
  al_saved: "Alerts saved",
  al_hub_sub: "{n}/{t} types on",
  al_thresholds: "THRESHOLDS",
  al_edge_note: "Edge only · no spam while stuck · recovery when fixed",
  al_grp_bridge: "Bridge",
  al_grp_node: "Node",
  al_grp_oracle: "Oracle",
  al_item_bridge: "Bridge offline",
  al_item_bridge_b: "Agent dropped / came back",
  al_item_unreachable: "Node unreachable",
  al_item_unreachable_b: "Bridge up but /info fails",
  al_item_peers: "Peers low",
  al_item_peers_b: "P2P under min peers",
  al_item_sync: "Sync lag",
  al_item_sync_b: "Behind headers or network tip",
  al_item_stuck: "Height stuck",
  al_item_stuck_b: "No new blocks ~30 min",
  al_item_ora_down: "Oracle DOWN",
  al_item_ora_down_b: "Agent not healthy / not posting",
  al_item_ora_lag: "Publish lag",
  al_item_ora_lag_b: "Last post older than threshold",
  al_item_ora_miss: "Missed refresh",
  al_item_ora_miss_b: "Not in last pool refresh",
  al_item_ora_gas: "Low gas",
  al_item_ora_gas_b: "Wallet under 0.5 ERG",
...
const RU: Record<MiniMsgKey, string> = {
  ...
  al_saved: "Алерты сохранены",
  al_hub_sub: "{n}/{t} типов вкл",
  al_thresholds: "ПОРОГИ",
  al_edge_note: "Только переходы · без спама · recovery при ок",
  al_grp_bridge: "Bridge",
  al_grp_node: "Нода",
  al_grp_oracle: "Oracle",
  al_item_bridge: "Bridge offline",
  al_item_bridge_b: "Агент упал / поднялся",
  al_item_unreachable: "Нода недоступна",
  al_item_unreachable_b: "Bridge online, /info не отвечает",
  al_item_peers: "Мало пиров",
  al_item_peers_b: "P2P ниже min peers",
  al_item_sync: "Sync lag",
  al_item_sync_b: "Отставание от headers / tip",
  al_item_stuck: "Height stuck",
  al_item_stuck_b: "Нет новых блоков ~30 мин",
  al_item_ora_down: "Oracle DOWN",
  al_item_ora_down_b: "Агент не healthy / не постит",
  al_item_ora_lag: "Lag публикации",
  al_item_ora_lag_b: "Пост старше порога",
  al_item_ora_miss: "Missed refresh",
  al_item_ora_miss_b: "Не в last pool refresh",
  al_item_ora_gas: "Low gas",
  al_item_ora_gas_b: "Кошелёк < 0.5 ERG",
