  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1 sm:gap-2 px-2.5 sm:px-4 py-2 rounded-2xl border border-[#FF7A3D]/40 bg-[#FF7A3D]/10 text-[#FF7A3D] text-[10px] sm:text-xs font-mono tracking-wider sm:tracking-widest hover:bg-[#FF7A3D]/20 hover:border-[#FF7A3D]/60 transition-all active:scale-[0.985]"
      >
